...
async def search_match(update, context):
    ...
    # Jika sedang punya partner, putuskan dulu
    ...
    if old_partner:
        ...
        set_search(old_partner, 0)

        try:
            await context.bot.send_message(
                old_partner,
                "❌ Partner kamu telah mengakhiri percakapan dan mencari teman baru.",
                reply_markup=menu
            )
        except:
            pass
...
"""
        ...
        await send(text, reply_markup=menu)
...
async def relay(update, context):
    ...
    if partner:
        try:
            ...
            await update.message.reply_text(
                "Partner terputus. Klik 🔎 Search untuk mencari teman baru.",
                reply_markup=menu
            )
